# COMPLETE CORRECTED ANSWERS (UNITS 1 TO 6)
...
## Q.4 a) What is a Hash Function? Explain different collision resolution techniques: Separate Chaining, Linear Probing, Quadratic Probing, and Double Hashing with examples. (6 Marks)
...
## Q.5 b) Given the following traversals, build a binary tree from them: In-order: D, B, H, E, I, A, F, C, G / Pre-order: A, B, D, E, H, I, C, F, G. Also write the Post-order traversal. (7 Marks)
...
## Q.6 b) Construct a Huffman Tree for the characters and their frequencies: A:5, B:9, C:12, D:13, E:16, F:45. Find the Huffman code for each character. (7 Marks)
